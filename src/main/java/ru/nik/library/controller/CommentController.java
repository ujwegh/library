...
public class CommentController {
    ...
    public String getComments(@PathVariable("bookId") String bookId, Model model) {
        ...
        Flux<Comment> comments = service.getAllComments(bookId);
    ...
    public String edit(@PathVariable("id") String id, @PathVariable("bookId") String bookId, Model model) {
        ...
        Mono<Comment> comment = service.getCommentById(id, bookId);
        model.addAttribute("bookId", comment.map(comment1 -> comment1.getBook().getId()));
